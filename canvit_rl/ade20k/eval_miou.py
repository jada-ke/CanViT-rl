...
class TrainedPolicy:
    ...
    def step(self, t: int, state: RecurrentState) -> Viewpoint:
        ...
        # Problem: eval duplicated train's action->Viewpoint mapping.
        # Solution: use the shared policy helper with the historical 0.05
        # minimum scale. Result: train/eval share one conversion contract.
        return action_to_viewpoint(action, min_scale=0.05)
