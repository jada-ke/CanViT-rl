...
Usage:
    python scripts/analysis/ade20k/visualize_policy_glimpses.py
    python scripts/analysis/ade20k/visualize_policy_glimpses.py --image-index 0 --t 5 --k 32
    python scripts/analysis/ade20k/visualize_policy_glimpses.py --policy eg-c2f --t 5 --image-index 3648 --split training
...
# Problem: this module moved from scripts/ into canvit_rl, so relative sibling
...
def _build_dataset(*, root: Path, split: str, cfg: CanViTEnvConfig, img_tf, mask_tf):
    """Build ADE20K or synthetic segmentation data through the shared helper."""
