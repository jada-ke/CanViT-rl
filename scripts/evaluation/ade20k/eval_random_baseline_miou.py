...
Usage:
    uv run python scripts/evaluation/ade20k/eval_random_baseline_miou.py
    uv run python scripts/evaluation/ade20k/eval_random_baseline_miou.py --t 5 --miou-mode mean
    uv run python scripts/evaluation/ade20k/eval_random_baseline_miou.py --t 5 --miou-mode accumulator
"""
