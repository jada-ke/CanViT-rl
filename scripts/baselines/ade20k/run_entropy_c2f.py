...
Usage:
    python scripts/baselines/ade20k/run_entropy_c2f.py --episodes 5
    python scripts/baselines/ade20k/run_entropy_c2f.py --episodes 5 --t 5 --dataset datasets/ADE20k
    python scripts/baselines/ade20k/run_entropy_c2f.py --all --t 21
"""
